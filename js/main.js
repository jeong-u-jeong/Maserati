...
$(function(){
    ...
    $('.lab3').on('click', function(){
        $('.page03 .contents .container_box .container3 div .img_box img').delay(500).fadeIn(1000);
        $('.page03 .contents .container_box .container3 div .text_box p ').delay(1500).fadeIn(1000);
    });
